...
from backend.schemas.resume import ResumeCreate, ResumeResponse, HistoryItem
...
async def save_resume(
    ...
    resume = await create_resume(db, current_user.id, data.model_dump())
    return ResumeResponse.model_validate(resume, from_attributes=True)
...
async def edit_resume(
    ...
    resume = await update_resume(db, resume, data.model_dump())
    return ResumeResponse.model_validate(resume, from_attributes=True)
